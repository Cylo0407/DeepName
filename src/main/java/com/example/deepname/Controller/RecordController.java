...
public class RecordController {
    ...
    public MyResponse searchRecordsByUsername(@Valid @RequestParam String username){
     ...
     */
    @GetMapping("/idSearch")
    public MyResponse searchRecordsById(@Valid @RequestParam Integer id){
     ...
     */
    @PostMapping("/delete")
    public MyResponse deleteRecord(@Valid @RequestParam Integer id){
