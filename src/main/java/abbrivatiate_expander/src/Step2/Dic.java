...
public class Dic {
    ...
    static {
        // init english dic
        try {
            BufferedReader reader = new BufferedReader(new FileReader(Util.englishDicFile));
            String temp;
        ...
        // init abbr dic
        ArrayList<String> file = Util.readFile(Util.abbrDicFile);
        for (String str : file) {
        ...
        ArrayList<String> file2 = Util.readFile(Util.computerAbbrDicFile);
