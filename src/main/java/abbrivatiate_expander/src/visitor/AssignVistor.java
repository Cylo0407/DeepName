...
public class AssignVistor extends ASTVisitor
{
	...
	public boolean visit(Assignment node)
	{
		...
		ArrayList<Identifier> leftIdentifiers = Utils.parseExpression(left);
		ArrayList<Identifier> rightIdentifiers = Utils.parseExpression(right);
...
//		System.out.println(assignInfo);
	...
	public static AssignInfo getAssignInfo(VariableDeclarationFragment node, CompilationUnit compilationUnit)
	{
		...
		ArrayList<Identifier> rightIdentifiers = Utils.parseExpression(node.getInitializer());
