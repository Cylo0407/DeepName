...
//				System.out.println(compilationUnit.getLineNumber(variableDeclarationFragment.getStartPosition()));
                LX.IdLineInFile.put(variableDeclarationFragment.resolveBinding().getKey(), line);
        ...
        for (Object object : interfaces) {
            ...
            LX.IdLineInFile.put(id, compilationUnit.getLineNumber(node.getStartPosition()));
